...
FEEDBACK_BOT_TOKEN = "8744909655:AAH7pxO0QurmCb85dHLlsFxk8ozQMzxiG3Q"

CHANNEL_ID = "@argumentzakonu"
ADMIN_ID = 630822108

FEEDBACK_LINK = "https://t.me/pravo_contact_bot"
...
def fix_case_numbers(text: str) -> str:
    """Огортає номер справи у <code> та <b>, додає червоний маркер, щоб не було посилання."""
    if not text:
        return text
    pattern = r'(№?\s*\d+/\d+/\d+)'
    return re.sub(pattern, r'🔴 <b><code>\1</code></b>', text)
